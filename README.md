...
medical-harness - Medical AI Project
...
1. **构建镜像**
```bash
docker build -t medical-harness .
```

2. **运行容器**
```bash
docker run -d -p 8000:8000 --name medical-harness medical-harness
```
...
- **问题反馈**: https://github.com/MoKangMedical/medical-harness/issues
